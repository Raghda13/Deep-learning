...
Original file is located at
    https://colab.research.google.com/drive/1T9ssZ-eil4xTMkImTCkWaiDlCTF1nu4i
"""
...
#to avoid over training the model
...
#plot accuracy models for training and validation sets
plt.figure(figsize=(5, 5))
...
#plot accuracy curve for the fine-tune model
plt.figure(figsize=(5, 5))
plt.plot(history.history['accuracy'], label='Training Accuracy')
plt.plot(history.history['val_accuracy'], label='Validation Accuracy')
plt.title('Accuracy Curve')
